...
**React Developer | Next.js · TypeScript · JavaScript @ Xedrum IT Company** ✨ [@https://xedrum.com](https://xedrum.com)
...
<div style="display: flex; flex-wrap: wrap; gap: 10px; align-items: center;">
  ...
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/graphql/graphql-plain.svg" width="50" height="50" alt="GraphQL" title="GraphQL" />
...
## Key Skills
- **Frontend:** React, Next.js (App Router), TypeScript, JavaScript
- **State Management:** Zustand, Context API, TanStack React Query, Redux Toolkit
- **Styling:** CSS, Tailwind CSS, PostCSS, HeroUI (NextUI), Material UI
- **APIs:** REST API, Fetch API, Stripe.js
- **Tools:** Git, CI/CD, Tesseract.js, i18next, next-intl
- **Architecture:** Modular API layer, Provider pattern, Custom hooks, Type-safe configuration
